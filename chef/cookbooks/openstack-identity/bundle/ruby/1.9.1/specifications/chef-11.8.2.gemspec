...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<chef-zero>, [">= 1.6.2", "~> 1.6"])
      s.add_runtime_dependency(%q<puma>, ["~> 1.6"])
      ...
      s.add_development_dependency(%q<rspec-core>, ["~> 2.13.0"])
      ...
      s.add_dependency(%q<chef-zero>, [">= 1.6.2", "~> 1.6"])
