...
Gem::Specification.new do |s|
  ...
  s.homepage = "https://github.com/RiotGames/buff-platform"
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_development_dependency(%q<buff-ruby_engine>, [">= 0"])
      ...
      s.add_dependency(%q<buff-ruby_engine>, [">= 0"])
